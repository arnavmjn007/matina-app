...
const PersonalityStep = ({ data, setFormData }) => {
    /**
     * Handles changes for any of the personality questions.
     * @param {string} key - The key of the question to update (e.g., 'q1_care').
     * @param {string} value - The selected value from the radio button.
     */
    ...
    return (
        <div className="space-y-8">
            ...
            <div>
                ...
                <Radio.Group
                    value={data.userPersonality.q1_care}
                    onChange={(e) => handleChange('q1_care', e.target.value)}
            ...
            <div>
                ...
                <Radio.Group
                    value={data.userPersonality.q2_love}
                    onChange={(e) => handleChange('q2_love', e.target.value)}
                    className="mt-2 flex flex-col space-y-2"
                >
            ...
            <div>
                ...
                <Radio.Group
                    value={data.userPersonality.q3_cute}
                    onChange={(e) => handleChange('q3_cute', e.target.value)}
                    className="mt-2 flex flex-col space-y-2"
                >
